        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepartmentImage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsDelete = table.Column<bool>(type: "bit", nullable: false),
                    CreateUser = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorMajor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DoctorGender = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DoctorAcheivment = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DoctorStartTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DoctorEndTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DoctorAppointmentDuration = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsDelete = table.Column<bool>(type: "bit", nullable: false),
                    CreateUser = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PatientId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PatientNId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PatientNationality = table.Column<string>(type: "nvarchar(max)", nullable: false),
